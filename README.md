...
«Разрешение входа» — множитель размера карты глубины. Без «Сжать до 14px» диапазон 1–5, и **5x может потребовать ~32 ГБ ОЗУ** (модель large). Начинайте с 1–2x. С «Сжать до 14px» диапазон 1–100 — там вход сжимается к 14px, расход памяти небольшой.
